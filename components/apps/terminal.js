...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "personal", "skills", "IIITL", "interests"],
            IIITL: ["Sem-6"],
            skills: ["MongoDB", "Express.js", "React.js", "Nodejs", "Django", "Python", "Golang", "Docker", "Javascript", "Python", "C++"],
            projects: ["IIITL-events", "Server-of-IIITL-events", "Faculty-Recruitment-Portal", "Vaibhav-Assistant"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">gopivaibhav@Asus-Rog</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            case "cd":
                ...
                if (rest === "personal") {
                    result = `bash /${this.curr_dir_name} : Ahem, They are my personal. Hence, Permission denied 😏(Dont be smart using 'sudo' command)`;
                    break;
                }
            ...
            case "ls":
                ...
                if (target in this.child_directories) {
                    ...
                    result = "Nope! 🙃 they are my personal😏 (Dont be smart using 'sudo' command)";
                    break;
                }
                else {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/gopivaibhav")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-gopi, trash, settings, sendmsg]";
                }
                break;
            case "echo":
